...
export function EtkinlikContent() {
  ...
  return (
    <div className="min-h-svh bg-[#1a1210]" data-section-dark>
      <div className="relative h-[50vh] min-h-[320px] overflow-hidden">
        <Image
          src="/melis-orhan/myrina-garden.webp"
          alt="Festival Düğün Salonu"
          fill
          className="object-cover object-top"
          sizes="100vw"
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#1a1210] via-[#1a1210]/50 to-transparent" />

        <div className="absolute bottom-8 left-6 md:left-12 z-10">
          <p className="font-sans text-xs tracking-[0.3em] uppercase text-[#c75050] mb-2">
            {t("eventLabel")}
          </p>
            ...
            <div className="grid sm:grid-cols-3 gap-4 text-sm">
              {wedding.venueAddress && (
                <div className="flex items-start gap-2.5">
                  <div className="w-9 h-9 rounded-full bg-[#c75050]/10 flex items-center justify-center shrink-0 mt-0.5">
              ...
              <div className="flex items-start gap-2.5">
                <div className="w-9 h-9 rounded-full bg-[#d4898a]/10 flex items-center justify-center shrink-0 mt-0.5">
                  <CalendarIcon className="size-4 text-[#d4898a]" size={16} />
                </div>
                <div>
                  <p className="font-sans text-[10px] uppercase tracking-wider text-white/30 mb-1">
                    {t("venueDate")}
              ...
              {wedding.weddingTime && (
                <div className="flex items-start gap-2.5">
                  <div className="w-9 h-9 rounded-full bg-[#c9a96e]/10 flex items-center justify-center shrink-0 mt-0.5">
                    <ClockIcon className="size-4 text-[#c9a96e]" size={16} />
                  </div>
                  <div>
                    <p className="font-sans text-[10px] uppercase tracking-wider text-white/30 mb-1">
                      {t("venueTime")}
          ...
          >
            <div className="bg-white/5 rounded-3xl border border-white/10 p-6 md:p-8">
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-1 text-[13px]">
                {wedding.brideFamily && (
                  <>
                    <p className="font-sans text-[10px] uppercase tracking-[0.15em] text-[#d4898a]/60 col-span-1 pt-2">
                      {t("eventBrideFamily")}
                    </p>
                    <p className="font-sans text-[10px] uppercase tracking-[0.15em] text-[#c75050]/60 col-span-1 pt-2">
                      {t("eventGroomFamily")}
                    </p>
