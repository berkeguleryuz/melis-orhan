...
export function RoseFooter() {
  ...
  const pageLinks = [
    ...
    ...(wedding.hasMemoryBook
      ...
      : []),
    { label: t("navRsvp"), href: `/lcv` },
  ];

  return (
    <footer className="bg-[#1a1210]">
      <div className="max-w-5xl mx-auto px-6 md:px-12 pt-16 pb-8">
        <div className="bg-gradient-to-r from-[#c75050]/10 to-[#d4898a]/10 border border-white/10 rounded-3xl p-8 md:p-12 text-center">
          <HeartIcon className="size-7 text-[#d4898a] mx-auto mb-5" size={28} />
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 bg-gradient-to-r from-[#c75050] to-[#d4898a] text-white rounded-full px-8 py-3 font-sans text-sm font-medium tracking-wide hover:opacity-90 transition-opacity group"
          >
            {t("footerCtaButton")}
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 py-12">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-12">
          <div>
            <h3 className="font-merienda text-3xl bg-gradient-to-r from-[#c75050] to-[#d4898a] bg-clip-text text-transparent">
