...
const inputClassDark =
  "w-full h-12 rounded-2xl border border-white/10 bg-white/5 px-4 text-base sm:text-sm text-white placeholder:text-white/30 focus:border-[#c75050] focus:outline-none focus:ring-2 focus:ring-[#c75050]/20 transition-all font-sans";
      ...
      >
        <div className="bg-white/5 rounded-3xl border border-white/10 p-6 md:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="bg-[#c75050]/10 border border-[#c75050]/20 rounded-2xl px-4 py-3">
              <p className="font-sans text-xs text-[#c75050] leading-relaxed">
      ...
      {isLoading ? (
        ...
        >
          <div className="text-center py-16 space-y-3">
            <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#c75050]/10 to-[#d4898a]/10 border border-white/10 flex items-center justify-center mx-auto mb-4">
